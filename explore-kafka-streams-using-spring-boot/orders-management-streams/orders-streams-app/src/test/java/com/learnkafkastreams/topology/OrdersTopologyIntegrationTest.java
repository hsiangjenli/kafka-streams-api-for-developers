...
public class OrdersTopologyIntegrationTest {
  ...
  @Autowired OrderWindowsService orderWindowsService;
  ...
  void ordersRevenue_multiOrdersByWindows() throws InterruptedException {
    ...
    Awaitility.await()
        ...
        .ignoreExceptions()
        .until(
            () -> orderWindowsService.getOrderRevenueWindowsByType(GENERAL_ORDERS).size(),
            equalTo(1));
    ...
    Awaitility.await()
        ...
        .ignoreExceptions()
        .until(
            () -> orderWindowsService.getOrderRevenueWindowsByType(RESTAURANT_ORDERS).size(),
            equalTo(1));
