package com.learnkafkastreams.greeting_streams_springboot.producer;

import static com.learnkafkastreams.greeting_streams_springboot.producer.ProducerUtil.publishMessageSync;
...
public class GreetingMockDataProducer {
  ...
  private static void spanishGreetings(ObjectMapper objectMapper) {
    var spanishGreetings = List.of(new Greeting("Hello, Good Morning!", LocalDateTime.now()),
  ...
  private static void englishGreetings(ObjectMapper objectMapper) {
    var spanishGreetings = List.of(new Greeting("¡Hola buenos dias!", LocalDateTime.now()),
