...
public class OrdersTopology {
  ...
  public static Topology buildTopology() {
    ...
    orderStream.split(Named.as("General-Restaurant-Stream"))
        .branch(generalPredicate, Branched.withConsumer(generalOrderStream -> {
          ...
          aggregateOrdersCountByTimeWindows(generalOrderStream, GENERAL_ORDERS_COUNT_WINDOWS,
              storesTable);
          aggregateOrderByRevenue(generalOrderStream, GENERAL_ORDERS_REVENUE, storesTable);
          aggregateOrdersRevenueByTimeWindows(generalOrderStream, GENERAL_ORDERS_REVENUE_WINDOWS,
              storesTable);
          ...
          aggregateOrdersCountByTimeWindows(restaurantOrderStream, RESTAURANT_ORDERS_COUNT_WINDOWS,
              storesTable);
  ...
  private static void aggregateOrdersRevenueByTimeWindows(KStream<String, Order> generalOrderStream,
    ...
    revenueTable.toStream().map((key, value) -> KeyValue.pair(key.key(), value))
        .join(storesTable, valueJoiner, joinedParams).print(
  ...
  private static void aggregateOrdersCountByTimeWindows(KStream<String, Order> generalOrderStream,
    ...
    KTable<Windowed<String>, Long> orderCountPerStore = generalOrderStream
        ...
        .groupByKey(Grouped.with(Serdes.String(), SerdesFactory.orderSerde()))
        .windowedBy(timeWindows).count(Named.as(storeName), Materialized.as(storeName)).suppress(
  ...
  public static void aggregateOrderByRevenue(KStream<String, Order> generalOrderStream,
    ...
    revenueWithStoreTable.toStream().print(
        Printed.<String, TotalRevenueWithAddress>toSysOut().withLabel(storeName + "-bystore"));
  }
